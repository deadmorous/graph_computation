...
using drange = gc_types::CoordinateRange<double>;
...
TEST(GcTypes, LiveTimeSeries_Basic)
{
    ...
    auto ts = gc_types::LiveTimeSeries{};
    ...
    for (auto index : common::index_range<size_t>(2*capacity))
    {
        ...
        auto expected_total_range = gc_types::combine_coordinate_range(
...
TEST(GcTypes, LiveTimeSeries_FrameByIndex)
{
    ...
    using Frame = gc_types::LiveTimeSeries::Frame;
...
TEST(GcTypes, LiveTimeSeries_Checkpoints)
{
    ...
    auto c1 = gc_types::LiveTimeSeries::Checkpoint{};
    auto c2 = gc_types::LiveTimeSeries::Checkpoint{};
