...
#define GCLIB_DEFAULT_A0_TO(DEFAULT, ...) \
    GCLIB_DEFAULT_A0_TO_N(DEFAULT, GCLIB_NUM_ARGS(__VA_ARGS__), ##__VA_ARGS__)

#define GCLIB_DEFAULT_A0_TO_N(DEFAULT, n, ...) \
    GCLIB_DEFAULT_A0_TO_N_IMPL(DEFAULT, n, ##__VA_ARGS__)

#define GCLIB_DEFAULT_A0_TO_N_IMPL(DEFAULT, n, ...) \
    GCLIB_DEFAULT_A0_TO_##n(DEFAULT, ##__VA_ARGS__)

#define GCLIB_DEFAULT_A0_TO_0(DEFAULT) DEFAULT
#define GCLIB_DEFAULT_A0_TO_1(DEFAULT, A0) A0
#define GCLIB_DEFAULT_A0_TO_2(DEFAULT, A0, ...) A0
#define GCLIB_DEFAULT_A0_TO_3(DEFAULT, A0, ...) A0
#define GCLIB_DEFAULT_A0_TO_4(DEFAULT, A0, ...) A0
#define GCLIB_DEFAULT_A0_TO_5(DEFAULT, A0, ...) A0
#define GCLIB_DEFAULT_A0_TO_6(DEFAULT, A0, ...) A0
#define GCLIB_DEFAULT_A0_TO_7(DEFAULT, A0, ...) A0
#define GCLIB_DEFAULT_A0_TO_8(DEFAULT, A0, ...) A0
#define GCLIB_DEFAULT_A0_TO_9(DEFAULT, A0, ...) A0
#define GCLIB_DEFAULT_A0_TO_10(DEFAULT, A0, ...) A0



#define GCLIB_DEFAULT_A1_TO(DEFAULT, ...) \
    GCLIB_DEFAULT_A1_TO_N(DEFAULT, GCLIB_NUM_ARGS(__VA_ARGS__), ##__VA_ARGS__)

#define GCLIB_DEFAULT_A1_TO_N(DEFAULT, n, ...) \
    GCLIB_DEFAULT_A1_TO_N_IMPL(DEFAULT, n, ##__VA_ARGS__)

#define GCLIB_DEFAULT_A1_TO_N_IMPL(DEFAULT, n, ...) \
    GCLIB_DEFAULT_A1_TO_##n(DEFAULT, ##__VA_ARGS__)

#define GCLIB_DEFAULT_A1_TO_0(DEFAULT) DEFAULT
#define GCLIB_DEFAULT_A1_TO_1(DEFAULT, A0) DEFAULT
#define GCLIB_DEFAULT_A1_TO_2(DEFAULT, A0, A1, ...) A1
#define GCLIB_DEFAULT_A1_TO_3(DEFAULT, A0, A1, ...) A1
#define GCLIB_DEFAULT_A1_TO_4(DEFAULT, A0, A1, ...) A1
#define GCLIB_DEFAULT_A1_TO_5(DEFAULT, A0, A1, ...) A1
#define GCLIB_DEFAULT_A1_TO_6(DEFAULT, A0, A1, ...) A1
#define GCLIB_DEFAULT_A1_TO_7(DEFAULT, A0, A1, ...) A1
#define GCLIB_DEFAULT_A1_TO_8(DEFAULT, A0, A1, ...) A1
#define GCLIB_DEFAULT_A1_TO_9(DEFAULT, A0, A1, ...) A1
#define GCLIB_DEFAULT_A1_TO_10(DEFAULT, A0, A1, ...) A1
