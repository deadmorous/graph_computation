 ...
 *  first argument of type `MandelbrotFineGraphImpl2_Tag`. The change done
 *  in this implementatoin is reducing the number of variables.
 *
 *  Benchmarks show 1.65x slowdown with resp. to the reference implementation.
 */
auto mandelbrot_set(MandelbrotFineGraphImpl3_Tag, const MandelbrotParam& param)
    -> Canvas
